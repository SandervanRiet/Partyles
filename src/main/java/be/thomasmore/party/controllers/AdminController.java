...
public class AdminController {
    ...
    public String partyEditPost(Model model,@RequestParam(required = false) Integer[] artistIds, @PathVariable int id, @Valid @ModelAttribute("party") Party party, BindingResult bindingResult) {
    ...
    public String partyNewPost(Model model,@RequestParam(required = false) Integer[] artistIds, @Valid @ModelAttribute("party") Party party, BindingResult bindingResult) {
